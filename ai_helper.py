...
def generate_plan(date_range, theme, location, budget):
    ...
    response = client.models.generate_content(
        ...
        contents=f"""
            ...
            Format the response in markdown for easy readability on frontend. For each day of itinerary, create dropdown sections for better readability. 
                Every day should have its own dropdown section.
            """
    )
